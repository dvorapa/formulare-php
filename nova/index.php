...
<Input Class="Znamka" Name="Predmet{$i}Rocnik2" Tabindex="{$t+2}" Type="Text" Value="${!empty($_SESSION['Predmet{$i}Rocnik2'])?$_SESSION['Predmet{$i}Rocnik2']:''}">
</Td><Td>
<Input Class="Znamka" Name="Predmet{$i}Rocnik3" Tabindex="{$t+3}" Type="Text" Value="${!empty($_SESSION['Predmet{$i}Rocnik3'])?$_SESSION['Predmet{$i}Rocnik3']:''}">
</Td><Td>
<Input Class="Znamka" Name="Predmet{$i}Rocnik4" Tabindex="{$t+4}" Type="Text" Value="${!empty($_SESSION['Predmet{$i}Rocnik4'])?$_SESSION['Predmet{$i}Rocnik4']:''}">
</Td><Td>
<Input Class="Znamka" Name="Predmet{$i}Rocnik5" Tabindex="{$t+5}" Type="Text" Value="${!empty($_SESSION['Predmet{$i}Rocnik5'])?$_SESSION['Predmet{$i}Rocnik5']:''}">
</Td><Td>
<Input Class="Znamka" Name="Maturita{$i}" Tabindex="{$t+6}" Type="Text" Value="${!empty($_SESSION['Maturita{$i}'])?$_SESSION['Maturita{$i}']:''}">
</Td></Tr>
EOT;
}
?>
