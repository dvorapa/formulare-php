...
Budete-li v budoucnu potřebovat tuto přihlášku znovu použít, zapište si prosím následující kód:<Br>
<H2><?php echo session_id(); ?></H2>
</Header>
<Section>
Vyberte prosím, jakým způsobem chcete přihlášku získat:<Br>
<Button Name="Stahnout[Kam]" Type="Submit" Value="/Export/<?php echo session_id(); ?>.php?Tisk">Tisk</Button><Br>
<Button Name="Stahnout[Kam]" Type="Submit" Value="/Export/<?php echo session_id(); ?>.php?Pdf">Pdf</Button><Br>
<Button Name="Stahnout[Kam]" Type="Submit" Value="/Export/<?php echo session_id(); ?>.php?Docx">Docx</Button><Br>
<Button Name="Stahnout[Kam]" Type="Submit" Value="/Export/<?php echo session_id(); ?>.php?Html">Html</Button><Br>
<A Href="/Export/<?php echo session_id(); ?>.php?Dalsi">Další</A>
</Section>
<Section>
Nebudete-li se k této přihlášce již vracet nebo chcete smazat uložené údaje, klikněte sem:<Br>
<Button Name="Smazat[Kam]" Type="Submit" Value="/"><I Class="icon-trash_can"></I></Button><Br>
Potřebujete-li upravit starší přihlášku nebo vytvořit novou, klikněte sem:<Br>
<Button Name="Prejit[Kam]" Type="Submit" Value="/"><I Class="icon-home"></I></Button><Br>
Není-li žádná z předchozích možností vhodná nebo si nejste jist(a), klikněte sem:<Br>
