...
<Input Id="VSkola" Name="VSkola" Tabindex="9" Type="Text" Value="<?php echo !empty($_SESSION['VSkola'])?$_SESSION['VSkola']:''; ?>"><Br>
<Label For="VFakulta">Fakulta</Label>
<Input Id="VFakulta" Name="VFakulta" Tabindex="10" Type="Text" Value="<?php echo !empty($_SESSION['VFakulta'])?$_SESSION['VFakulta']:''; ?>"><Br>
<Label For="VProgram">Studijní program</Label>
<Input Id="VProgram" Name="VProgram" Tabindex="11" Type="Text" Value="<?php echo !empty($_SESSION['VProgram'])?$_SESSION['VProgram']:''; ?>"><Br>
...
<Input Id="Jmeno" Name="Jmeno" Tabindex="16" Type="Text" Value="<?php echo !empty($_SESSION['Jmeno'])?$_SESSION['Jmeno']:''; ?>"><Br>
<Label For="Prijmeni">Příjmení</Label>
<Input Id="Prijmeni" Name="Prijmeni" Tabindex="17" Type="Text" Value="<?php echo !empty($_SESSION['Prijmeni'])?$_SESSION['Prijmeni']:''; ?>"><Br>
<Label For="Rodne">Rodné</Label>
<Input Id="Rodne" Name="Rodne" Tabindex="18" Type="Text" Value="<?php echo !empty($_SESSION['Rodne'])?$_SESSION['Rodne']:''; ?>"><Br>
<Label For="Tituly">Tituly</Label>
<Input Id="Tituly" Name="Tituly" Tabindex="19" Type="Text" Value="<?php echo !empty($_SESSION['Tituly'])?$_SESSION['Tituly']:''; ?>"><Br>
<Label>Pohlaví</Label>
...
<Input Id="DatumNar" Name="DatumNar" Tabindex="24" Type="Date" Value="<?php echo !empty($_SESSION['DatumNar'])?$_SESSION['DatumNar']:''; ?>"><Br>
<Label For="MistoNar">Místo narození</Label>
<Input Id="MistoNar" Name="MistoNar" Tabindex="25" Type="Text" Value="<?php echo !empty($_SESSION['MistoNar'])?$_SESSION['MistoNar']:''; ?>"><Br>
<Label For="OkresNar">Okres</Label>
<Input Id="OkresNar" Name="OkresNar" Tabindex="26" Type="Text" Value="<?php echo !empty($_SESSION['OkresNar'])?$_SESSION['OkresNar']:''; ?>"><Br>
<Label For="CisloOP">Číslo občanského průkazu</Label>
<Input Id="CisloOP" Name="CisloOP" Tabindex="27" Type="Number" Value="<?php echo !empty($_SESSION['CisloOP'])?$_SESSION['CisloOP']:''; ?>"><Br>
...
<Input Id="TCislo" Name="TCislo" Tabindex="32" Type="Text" Value="<?php echo !empty($_SESSION['TCislo'])?$_SESSION['TCislo']:''; ?>"><Br>
<Label For="TCast">Část obce</Label>
<Input Id="TCast" Name="TCast" Tabindex="33" Type="Text" Value="<?php echo !empty($_SESSION['TCast'])?$_SESSION['TCast']:''; ?>"><Br>
...
<Input Id="TPSC" Max="99999" Name="TPSC" Tabindex="35" Type="Number" Value="<?php echo !empty($_SESSION['TPSC'])?$_SESSION['TPSC']:''; ?>"><Br>
<Label For="TPosta">Pošta</Label>
<Input Id="TPosta" Name="TPosta" Tabindex="36" Type="Text" Value="<?php echo !empty($_SESSION['TPosta'])?$_SESSION['TPosta']:''; ?>"><Br>
...
<Input Id="KCislo" Name="KCislo" Tabindex="42" Type="Text" Value="<?php echo !empty($_SESSION['KCislo'])?$_SESSION['KCislo']:''; ?>"><Br>
<Label For="KCast">Část obce</Label>
<Input Id="KCast" Name="KCast" Tabindex="43" Type="Text" Value="<?php echo !empty($_SESSION['KCast'])?$_SESSION['KCast']:''; ?>"><Br>
...
<Input Id="KPSC" Max="99999" Name="KPSC" Tabindex="45" Type="Number" Value="<?php echo !empty($_SESSION['KPSC'])?$_SESSION['KPSC']:''; ?>"><Br>
<Label For="KPosta">Pošta</Label>
<Input Id="KPosta" Name="KPosta" Tabindex="46" Type="Text" Value="<?php echo !empty($_SESSION['KPosta'])?$_SESSION['KPosta']:''; ?>"><Br>
...
<Input Id="SSkola" Name="SSkola" Tabindex="51" Type="Text" Value="<?php echo !empty($_SESSION['SSkola'])?$_SESSION['SSkola']:''; ?>"><Br>
<Label For="SAdresa">Adresa</Label>
<Input Id="SAdresa" Name="SAdresa" Tabindex="52" Type="Text" Value="<?php echo !empty($_SESSION['SAdresa'])?$_SESSION['SAdresa']:''; ?>"><Br>
...
<Input Id="SJKOV" Name="SJKOV" Tabindex="54" Type="Number" Value="<?php echo !empty($_SESSION['SJKOV'])?$_SESSION['SJKOV']:''; ?>"><Br>
...
<Input Id="SKKOV" Name="SKKOV" Tabindex="56" Type="Text" Value="<?php echo !empty($_SESSION['SKKOV'])?$_SESSION['SKKOV']:''; ?>"><Br>
...
<Input Id="Zamestnavatel" Name="Zamestnavatel" Tabindex="72" Type="Text" Value="<?php echo !empty($_SESSION['Zamestnavatel'])?$_SESSION['Zamestnavatel']:''; ?>"><Br>
<Label For="Zarazeni">Pracovní zařazení</Label>
<Input Id="Zarazeni" Name="Zarazeni" Tabindex="73" Type="Text" Value="<?php echo !empty($_SESSION['Zarazeni'])?$_SESSION['Zarazeni']:''; ?>"><Br>
...
<Input Id="PSkola" Name="PSkola" Tabindex="76" Type="Text" Value="<?php echo !empty($_SESSION['PSkola'])?$_SESSION['PSkola']:''; ?>"><Br>
<Label For="PFakulta">Fakulta</Label>
<Input Id="PFakulta" Name="PFakulta" Tabindex="77" Type="Text" Value="<?php echo !empty($_SESSION['PFakulta'])?$_SESSION['PFakulta']:''; ?>"><Br>
<Label For="PProgram">Studijní program</Label>
<Input Id="PProgram" Name="PProgram" Tabindex="78" Type="Text" Value="<?php echo !empty($_SESSION['PProgram'])?$_SESSION['PProgram']:''; ?>"><Br>
<Label For="PObor">Studijní obor</Label>
<Input Id="PObor" Name="PObor" Tabindex="79" Type="Text" Value="<?php echo !empty($_SESSION['PObor'])?$_SESSION['PObor']:''; ?>"><Br>
...
<P>
Akademický rok: <?php echo !empty($_SESSION["AkadRok"])?$_SESSION["AkadRok"]:"<B>Chybí</B>"; ?><Br>
Program: <?php echo !empty($_SESSION["Program"])?$_SESSION["Program"]:"<B>Chybí</B>"; ?><Br>
Forma: <?php echo !empty($_SESSION["Forma"])?$_SESSION["Forma"]:"<B>Chybí</B>"; ?><Br>
Jazyk: <?php echo !empty($_SESSION["Jazyk"])?$_SESSION["Jazyk"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#VysokaSkola"><I Class="icon-pen"></I></A>
<P>
Vysoká škola: <?php echo !empty($_SESSION["VSkola"])?$_SESSION["VSkola"]:"<B>Chybí</B>"; ?><Br>
Fakulta: <?php echo !empty($_SESSION["VFakulta"])?$_SESSION["VFakulta"]:"<B>Chybí</B>"; ?><Br>
Studijní program: <?php echo !empty($_SESSION["VProgram"])?$_SESSION["VProgram"]:"<B>Chybí</B>"; ?><Br>
Studijní obory: <?php echo !empty($_SESSION["VOborA"])?$_SESSION["VOborA"]:"<B>Chybí</B>"; ?><?php echo !empty($_SESSION["VOborB"])?", ".$_SESSION["VOborB"]:""; ?><?php echo !empty($_SESSION["VOborC"])?", ".$_SESSION["VOborC"]:""; ?><Br>
</P>
<A Href="#OsobniUdaje"><I Class="icon-pen"></I></A>
<P>
Jméno: <?php echo !empty($_SESSION["Jmeno"])?$_SESSION["Jmeno"]:"<B>Chybí</B>"; ?><Br>
Příjmení: <?php echo !empty($_SESSION["Prijmeni"])?$_SESSION["Prijmeni"]:"<B>Chybí</B>"; ?><Br>
Rodné: <?php echo !empty($_SESSION["Rodne"])?$_SESSION["Rodne"]:"<B>Chybí</B>"; ?><Br>
Tituly: <?php echo !empty($_SESSION["Tituly"])?$_SESSION["Tituly"]:"<B>Chybí</B>"; ?><Br>
Pohlaví: <?php echo !empty($_SESSION["Pohlavi"])?$_SESSION["Pohlavi"]:"<B>Chybí</B>"; ?><Br>
Státní příslušnost: <?php echo !empty($_SESSION["StatniPris"])?$_SESSION["StatniPris"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#Narozeni"><I Class="icon-pen"></I></A>
<P>
Datum narození: <?php echo !empty($_SESSION["DatumNar"])?$_SESSION["DatumNar"]:"<B>Chybí</B>"; ?><Br>
Místo narození: <?php echo !empty($_SESSION["MistoNar"])?$_SESSION["MistoNar"]:"<B>Chybí</B>"; ?><Br>
Okres narození: <?php echo !empty($_SESSION["OkresNar"])?$_SESSION["OkresNar"]:"<B>Chybí</B>"; ?><Br>
Číslo občanského průkazu: <?php echo !empty($_SESSION["CisloOP"])?$_SESSION["CisloOP"]:"<B>Chybí</B>"; ?><Br>
Rodné číslo: <?php echo !empty($_SESSION["RCislo"])?$_SESSION["RCislo"]:"<B>Chybí</B>"; ?><Br>
Číslo pasu: <?php echo !empty($_SESSION["CisloP"])?$_SESSION["CisloP"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#AdresaTrvalehoBydliste"><I Class="icon-pen"></I></A>
<P>
Ulice: <?php echo !empty($_SESSION["TUlice"])?$_SESSION["TUlice"]:"<B>Chybí</B>"; ?><Br>
Číslo: <?php echo !empty($_SESSION["TCislo"])?$_SESSION["TCislo"]:"<B>Chybí</B>"; ?><Br>
Část obce: <?php echo !empty($_SESSION["TCast"])?$_SESSION["TCast"]:"<B>Chybí</B>"; ?><Br>
Obec: <?php echo !empty($_SESSION["TObec"])?$_SESSION["TObec"]:"<B>Chybí</B>"; ?><Br>
Okres: <?php echo !empty($_SESSION["TOkres"])?$_SESSION["TOkres"]:"<B>Chybí</B>"; ?><Br>
PSČ: <?php echo !empty($_SESSION["TPSC"])?$_SESSION["TPSC"]:"<B>Chybí</B>"; ?><Br>
Telefon: <?php echo !empty($_SESSION["TTel"])?$_SESSION["TTel"]:"<B>Chybí</B>"; ?><Br>
Pošta: <?php echo !empty($_SESSION["TPosta"])?$_SESSION["TPosta"]:"<B>Chybí</B>"; ?><Br>
Stát: <?php echo !empty($_SESSION["TStat"])?$_SESSION["TStat"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#KontaktniAdresa"><I Class="icon-pen"></I></A>
<P>
Ulice: <?php echo !empty($_SESSION["KUlice"])?$_SESSION["KUlice"]:"<B>Chybí</B>"; ?><Br>
Číslo: <?php echo !empty($_SESSION["KCislo"])?$_SESSION["KCislo"]:"<B>Chybí</B>"; ?><Br>
Část obce: <?php echo !empty($_SESSION["KCast"])?$_SESSION["KCast"]:"<B>Chybí</B>"; ?><Br>
Obec: <?php echo !empty($_SESSION["KObec"])?$_SESSION["KObec"]:"<B>Chybí</B>"; ?><Br>
Okres: <?php echo !empty($_SESSION["KOkres"])?$_SESSION["KOkres"]:"<B>Chybí</B>"; ?><Br>
PSČ: <?php echo !empty($_SESSION["KPSC"])?$_SESSION["KPSC"]:"<B>Chybí</B>"; ?><Br>
Telefon: <?php echo !empty($_SESSION["KTel"])?$_SESSION["KTel"]:"<B>Chybí</B>"; ?><Br>
Pošta: <?php echo !empty($_SESSION["KPosta"])?$_SESSION["KPosta"]:"<B>Chybí</B>"; ?><Br>
Stát: <?php echo !empty($_SESSION["KStat"])?$_SESSION["KStat"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#StredniSkola"><I Class="icon-pen"></I></A>
<P>
Název: <?php echo !empty($_SESSION["SSkola"])?$_SESSION["SSkola"]:"<B>Chybí</B>"; ?><Br>
Adresa: <?php echo !empty($_SESSION["SAdresa"])?$_SESSION["SAdresa"]:"<B>Chybí</B>"; ?><Br>
Obor: <?php echo !empty($_SESSION["SJObor"])?$_SESSION["SJObor"]:"<B>Chybí</B>"; ?><Br>
JKOV: <?php echo !empty($_SESSION["SJKOV"])?$_SESSION["SJKOV"]:"<B>Chybí</B>"; ?><Br>
Obor: <?php echo !empty($_SESSION["SKObor"])?$_SESSION["SKObor"]:"<B>Chybí</B>"; ?><Br>
KKOV: <?php echo !empty($_SESSION["SKKOV"])?$_SESSION["SKKOV"]:"<B>Chybí</B>"; ?><Br>
IZO: <?php echo !empty($_SESSION["SIZO"])?$_SESSION["SIZO"]:"<B>Chybí</B>"; ?><Br>
Rok maturitní zkoušky: <?php echo !empty($_SESSION["SRokMat"])?$_SESSION["SRokMat"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#UchazecSeHlasi"><I Class="icon-pen"></I></A>
<P>
Uchazeč se hlásí (z/ze/přes): <?php echo !empty($_SESSION["Odkud"])?$_SESSION["Odkud"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#ZajmovaCinnost"><I Class="icon-pen"></I></A>
<P>
Zájmová činnost, úspěchy: <?php echo !empty($_SESSION["Zajmy"])?$_SESSION["Zajmy"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#PrubehZamestnani"><I Class="icon-pen"></I></A>
<P>
Zaměstnavatel: <?php echo !empty($_SESSION["Zamestnavatel"])?$_SESSION["Zamestnavatel"]:"<B>Chybí</B>"; ?><Br>
Pracovní zařazení: <?php echo !empty($_SESSION["Zarazeni"])?$_SESSION["Zarazeni"]:"<B>Chybí</B>"; ?><Br>
Od: <?php echo !empty($_SESSION["ZOd"])?$_SESSION["ZOd"]:"<B>Chybí</B>"; ?><Br>
Do: <?php echo !empty($_SESSION["ZDo"])?$_SESSION["ZDo"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#PredchoziVysokaSkola"><I Class="icon-pen"></I></A>
<P>
Vysoká škola: <?php echo !empty($_SESSION["PSkola"])?$_SESSION["PSkola"]:"<B>Chybí</B>"; ?><Br>
Fakulta: <?php echo !empty($_SESSION["PFakulta"])?$_SESSION["PFakulta"]:"<B>Chybí</B>"; ?><Br>
Program: <?php echo !empty($_SESSION["PProgram"])?$_SESSION["PProgram"]:"<B>Chybí</B>"; ?><Br>
Obor: <?php echo !empty($_SESSION["PObor"])?$_SESSION["PObor"]:"<B>Chybí</B>"; ?><Br>
Od: <?php echo !empty($_SESSION["POd"])?$_SESSION["POd"]:"<B>Chybí</B>"; ?><Br>
Do: <?php echo !empty($_SESSION["PDo"])?$_SESSION["PDo"]:"<B>Chybí</B>"; ?><Br>
Udělený titul: <?php echo !empty($_SESSION["PTitul"])?$_SESSION["PTitul"]:"<B>Chybí</B>"; ?><Br>
</P>
<A Href="#Prospech"><I Class="icon-pen"></I></A>
<P>
<?php
for($i=1;$i<=27;$i++){
